...
export async function instantiate(imports={}, runInitializer=true) {
    ...
    const js_code = {
        ...
        'kotlinx.datetime.internal.JSJoda.Companion_$external_object_getInstance_9' : () => _ref_QGpzLWpvZGEvY29yZQ_.Duration,
        ...
        ,
        'com.gym.frontend.ui.admin.kineticQrStart_$external_fun' : (p0) => kineticQrStart(p0),
        'com.gym.frontend.ui.admin.kineticQrStop_$external_fun' : () => kineticQrStop(),
        'com.gym.frontend.ui.admin.kineticQrReadDetail_$external_fun' : (p0) => kineticQrReadDetail(p0),
        'com.gym.frontend.ui.config.kineticGetConfig_$external_fun' : (p0) => kineticGetConfig(p0),
        'com.gym.frontend.ui.config.kineticGetOrigin_$external_fun' : () => kineticGetOrigin(),
        'com.gym.frontend.ui.config.kineticGetHostname_$external_fun' : () => kineticGetHostname()
    }
